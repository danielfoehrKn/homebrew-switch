class Switcher < Formula
  ...
  if OS.mac?
    url "https://github.com/danielfoehrKn/kubeswitch/releases/download/4.0.2/switcher_darwin_amd64"
    sha256 "d0780b1a3cfb05a0e937512dfac2e582b586ceab6d3190e722d99a32ebd07346"
  elsif OS.linux?
    url "https://github.com/danielfoehrKn/kubeswitch/releases/download/4.0.2/switcher_linux_amd64"
